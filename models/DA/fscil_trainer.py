...
class FSCILTrainer(Trainer):
    ...
    def train(self):
        ...
        for session in range(args.start_session, args.sessions):
            ...
            if session == 0 and not hasattr(self, "_fg_checked"):
                is_fg, score = check_fine_grained(self.model, trainloader)
            
                print("\n==============================")
                print(" DATASET TYPE CHECK")
                print("------------------------------")
                print("Fine-grained:", is_fg)
                print("Score:", round(score, 4))
                print("==============================\n")
            
                self.is_fine_grained = is_fg
                self._fg_checked = True
                self.model.is_fine_grained = is_fg
                self.model.fg_score = score
